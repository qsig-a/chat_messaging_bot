...
class ChatAdapter(Protocol):
    ...
    async def post(
        ...
        """Post to a channel, optionally with files.

        The returned MessageRef's message_id may be empty when the platform's
        upload API does not surface a message timestamp (Slack's does not).
        Callers must not assume a file post can be reacted to or replied to.
        """
        ...
